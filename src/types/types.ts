export const auth = {
  ...
  password: {
    ...
    invalid:
      'La contraseña debe tener al menos una letra, un numero y ser mayor a 8 caracteres',
  ...
  password2: {
    ...
    invalid:
      'La confirmacion de contraseña debe ser igual a la contraseña ingresada',
  },
};
